...
/**
 * Same integration tests as {@link PetApiH2Test} but run against PostgreSQL.
 * Requires a local PostgreSQL instance with an empty "pet" database (see application.yaml).
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("postgresql")
class PetApiPostgresTest {
