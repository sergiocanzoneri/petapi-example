...
// Condition to check whether the database type is non-relational (currently only MongoDB to be supported).
public class NoSqlDatabaseCondition implements Condition {
